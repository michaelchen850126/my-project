...
.vs-alert
  ...
  *::selection
  ...
  &--shadow
    background: transparent
    box-shadow: 0px 4px 15px 0px -color('color', .12)
  &--gradient
    background: -color('color', 1)
    color: #fff
    border-radius: 12px
  ...
  &--relief
    ...
    color: #fff
    border-radius: 12px
    box-shadow: 6px 6px 0px 0px -color('color', .3)
    .vs-alert__icon
      i
        color: #fff
      svg
...
.vs-alert__close
  ...
  box-shadow: 0px 0px 0px 0px -color('color', .3)
  border-radius: 10px
  padding: 0px
  ...
  &:hover
    transform: translate(0,-2px)
    box-shadow: 0px 5px 18px 0px -color('color', .3)
  svg
    fill: -color('color')
